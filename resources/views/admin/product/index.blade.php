                ...
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Tên {{ $name_item }}</th>   
                            <th class="text-center">Giá {{ $name_item }}</th>
                            <th class="text-center">Giá {{ $name_item }} sau khi giảm</th>
                    ...
                    <tbody>
                        @foreach($items as $item)
                            <tr id="tr-item-">
                                ...
                                <td class="text-left tr-detail-item" style="cursor: pointer; color: #1b6aaa;">{{ $item->name }}</td>
                                <td class="text-center">{{ fotmatPrice($item->price) }}</td>
                                <td class="text-center">{{ fotmatPrice($item->sale_price) }}</td>
                                <td class="text-center">{!! createStatus($item->status, $item->id, 'product') !!}</td>
                                <td class="text-center">{{ $item->created_at }}</td>
                                <td class="text-center">
                                    <a href="{{ url("admin/{$prefix}/edit/{$item->id}") }}"><i class="fa fa-pencil-square-o edit-item" title="Sửa" style="cursor:pointer;"></i></a>

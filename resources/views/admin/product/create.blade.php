...
?>
<div class="products">
    <form action="{{ url("admin/{$prefix}/store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="basic-info">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name="title" value="{{ old('title') }}" id="title" value="" class="form-control" placeholder="Nhập title {{ $name_item }}" />                          
                            @error('title')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="price" value="{{ old('price') }}" id="price" value="" class="form-control" placeholder="Nhập giá {{ $name_item }} vd: 100000" />                          
                            @error('price')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="sale_price" value="{{ old('sale_price') }}" id="sale_price" value="" class="form-control" placeholder="Nhập giá {{ $name_item }} sau khi đã khuyến mãi  vd: 90000" />                          
                            @error('sale_price')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea type="text" name="description" id="description" value="" class="form-control" placeholder="Nhập chi tiết {{ $name_item }}">{{ old('description') }}</textarea>                          
                            @error('description')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>

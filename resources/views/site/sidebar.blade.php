<div class="sidebar sidebar-fixed hidden-xs hidden-sm hidden-md">
    <ul class="nav nav-pills nav-list nav-stacked">
        ...
        <li><a href="{{ url("admin/order") }}"><i class="fa fa-shopping-cart"></i>Đơn hàng</a></li>
        <li><a href="{{ url("admin/category") }}"><i class="fa fa-barcode"></i>Danh muc sản phẩm</a></li>
        <li><a href="{{ url("admin/product") }}"><i class="fa fa-barcode"></i>Sản phẩm</a></li>
